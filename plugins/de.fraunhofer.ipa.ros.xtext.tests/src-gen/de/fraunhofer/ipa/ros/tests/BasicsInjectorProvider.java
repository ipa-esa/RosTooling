...
public class BasicsInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new BasicsStandaloneSetup() {
			@Override
	...
	protected BasicsRuntimeModule createRuntimeModule() {
		...
		return new BasicsRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return BasicsInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
